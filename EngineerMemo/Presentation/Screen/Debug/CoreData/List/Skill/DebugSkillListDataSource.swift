    ...
    final class DebugSkillListDataSource: UITableViewDiffableDataSource<
        DebugSkillListContentViewSection,
        ProfileModelObject
    > {
        ...
        override func tableView(
            ...
            if editingStyle == .delete {
                didDeletedModelObjectSubject.send(modelObjects[indexPath.row])
    ...
    private extension DebugSkillListDataSource {
        func applySnapshot() {
