...
final class BasicUpdateGenderInputView: UIView {
...
extension BasicUpdateGenderInputView {
...
private extension BasicUpdateGenderInputView {
    func setupView() {
        configure {
            $0.addSubview(body) {
...
// MARK: - preview
    ...
    struct BasicUpdateGenderInputViewPreview: PreviewProvider {
        static var previews: some View {
            WrapperView(view: BasicUpdateGenderInputView())
        }
    }
#endif
